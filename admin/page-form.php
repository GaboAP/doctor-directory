    ...
    <div class="dd-form-card">
        <form method="post" action="" id="dd-doctor-form" novalidate>
            ...
            <div class="dd-field <?php echo isset($errors['full_name']) ? 'dd-field--error' : ''; ?>">
                ...
                <span class="dd-error-msg <?php echo isset($errors['full_name']) ? 'dd-error-visible' : ''; ?>" id="err-full_name">
            ...
            <div class="dd-field <?php echo isset($errors['email']) ? 'dd-field--error' : ''; ?>">
                ...
                <span class="dd-error-msg <?php echo isset($errors['email']) ? 'dd-error-visible' : ''; ?>" id="err-email">
            ...
            <div class="dd-field <?php echo isset($errors['address']) ? 'dd-field--error' : ''; ?>">
                ...
                <textarea
                    ...
                    name="address"
                    rows="3"
                    placeholder="123 Main St, City, Country"><?php echo esc_textarea($values['address']); ?></textarea>
                <span class="dd-error-msg <?php echo isset($errors['address']) ? 'dd-error-visible' : ''; ?>" id="err-address">
